...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print("You rolled a {x} and a {y}... What is the sum of {x} and {y}?".format(x=die_1_value, y=die_2_value))
    else:
        print("You rolled a {x} and a {y}... What is the difference between {x} and {y}?".format(x=die_1_value, y=die_2_value))
...
def input_answer():
    ...
    """
    # complete this function below here
    answer = input("Enter your response to the question: ").strip()
